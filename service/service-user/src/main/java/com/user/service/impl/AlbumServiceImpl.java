...
import com.user.dao.AlbumMapper;
import com.user.pojo.Album;
import com.user.service.AlbumService;
...
public class AlbumServiceImpl implements AlbumService {
    ...
    public Example createExample(Album album){
        ...
        if(album!=null){
            ...
            // 图片列表
            if(!StringUtils.isEmpty(album.getImageImageItems())){
                    criteria.andEqualTo("imageImageItems",album.getImageImageItems());
            }
        }
        return example;
    }
