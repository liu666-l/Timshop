...
import com.user.dao.ParaMapper;
import com.user.pojo.Para;
import com.user.service.ParaService;
...
public class ParaServiceImpl implements ParaService {
    ...
    public Example createExample(Para para){
        ...
        if(para!=null){
            ...
            // 模板ID
            if(!StringUtils.isEmpty(para.getTemplateTemplateId())){
                    criteria.andEqualTo("templateTemplateId",para.getTemplateTemplateId());
            }
        }
        return example;
    }
