...
import com.user.dao.SpecMapper;
import com.user.pojo.Spec;
import com.user.service.SpecService;
...
public class SpecServiceImpl implements SpecService {
    ...
    public Example createExample(Spec spec){
        ...
        if(spec!=null){
            ...
            // 模板ID
            if(!StringUtils.isEmpty(spec.getTemplateTemplateId())){
                    criteria.andEqualTo("templateTemplateId",spec.getTemplateTemplateId());
            }
        }
        return example;
    }
