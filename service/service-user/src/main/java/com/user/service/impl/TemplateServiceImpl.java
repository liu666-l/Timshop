...
import com.user.dao.TemplateMapper;
import com.user.pojo.Template;
import com.user.service.TemplateService;
...
public class TemplateServiceImpl implements TemplateService {
    ...
    public Example createExample(Template template){
        ...
        if(template!=null){
            ...
            // 规格数量
            if(!StringUtils.isEmpty(template.getSpecSpecNum())){
                    criteria.andEqualTo("specSpecNum",template.getSpecSpecNum());
            }
            // 参数数量
            if(!StringUtils.isEmpty(template.getParaParaNum())){
                    criteria.andEqualTo("paraParaNum",template.getParaParaNum());
            }
        }
        return example;
    }
